...
public class AdminSelectServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        selectspecies=speciesDao.SuperiorSelectSpeciesByEnvironment(name);//找到全部植物信息
...
//            }
//        }
        request.getSession().setAttribute("allspecies", selectspecies);
        response.sendRedirect("/gardens/admin_selectedplants.jsp");
