...
查看植物信息
 */
@WebServlet("/AdminSelectPlants")
public class AdminSelectPlants extends HttpServlet {
    private static final long serialVersionUID = 1L;
    public AdminSelectPlants() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 转发请求到JSP页面
        RequestDispatcher dispatcher = request.getRequestDispatcher("/select_species.jsp");
