...
@WebServlet("/Superior_PlantsDetailedServlet")
public class Superior_PlantsDetailedServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    public Superior_PlantsDetailedServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 转发请求到JSP页面
        RequestDispatcher dispatcher = request.getRequestDispatcher("/superior_plantdetailed.jsp");
