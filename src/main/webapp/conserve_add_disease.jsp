                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">增加病虫害</div>
                        </div>
                        <form action="/gardens/conserveAddDiseaseDo" method="post">
                            <div class="bootstrap-admin-panel-content">


                                <div class="form-group">
                                    <label>病名</label>
                                    <select class="form-control" name="dis_id" id="dis_name" required> <!-- 注意这里的 name 改为 species_id -->
                                        <c:forEach items="${diseaseBeans}" var="diseaseBeans">
                                            <!-- 使用 species_id 作为 value -->
                                            <option value="${diseaseBeans.dis_id}">${diseaseBeans.dis_name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>药名</label>
                                    <select class="form-control" name="med_id" id="med_name" required> <!-- 注意这里的 name 改为 species_id -->
                                        <c:forEach items="${medicineBeans}" var="medicineBeans">
                                            <!-- 使用 species_id 作为 value -->
                                            <option value="${medicineBeans.med_id}">${medicineBeans.med_name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>药剂用量</label>
                                    <input type="text" class="form-control" name="dis_mednum" id="dis_mednum"  required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>作用期限</label>
                                    <input type="date" class="form-control" name="dis_ddl" id="dis_ddl"  required>
                                </div>
