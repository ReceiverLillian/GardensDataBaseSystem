		...
		<!-- content -->
        			<div class="col-md-10">
        					...
        					<div class="col-lg-12">
        						<div class="panel panel-default bootstrap-admin-no-table-panel">
        							<div class="panel-heading">
        								<div class="text-muted bootstrap-admin-box-title">养护人员信息</div>
        							</div>
        						</div>
        					</div>
        				</div>
        				...
        				<div class="row">
							...
							<%
								ArrayList<UserBean> allconuser=(ArrayList<UserBean>)request.getSession().getAttribute("allconuser");
								for (UserBean bean : allconuser) {
