                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">监测管理</div>
                        </div>
                                ...
                                <c:forEach items="${monitorBeans}" var="monitorBeans" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/gardens/monitorAllPlantInfo?mon_id=${monitorBeans.mon_id}&dev_id=${deviceBeans[status.index].dev_id}&quo_id=${quotaBeans[status.index].quo_id}">
